...
enum class ContentSource { WALLHAVEN, PICSUM, BING, WIKIMEDIA, INTERNET_ARCHIVE, REDDIT, NASA, FREESOUND, JAMENDO, AUDIUS, CCMIXTER, LOCAL, YOUTUBE, PEXELS, PIXABAY, KLIPY, SOUNDCLOUD, COMMUNITY, BUNDLED, AI_GENERATED, OPEN_METEO }
