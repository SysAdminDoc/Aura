...
val providerDisclosures = listOf(
    ...
    ProviderDisclosure(
        ...
        licenseSummary = "NASA media guidelines; some images have third-party copyright",
        attribution = "Keep NASA APOD source links and photographer credit lines.",
        cachePolicy = "Cache daily image; random historical images cached per session.",
        userActions = "Browse, save, apply, download.",
        storeDisclosure = "Astronomy Picture of the Day from NASA public API.",
    ),
    ProviderDisclosure(
...
val providerRuntimeControls = listOf(
    ...
    ProviderRuntimeControl(
        ...
        disabledBehavior = "Disabled mode hides community tabs/uploads/votes/creator profile entry points, blocks feed/upload/follow repository calls, and records disabled diagnostics separately from Firebase outages. Fresh installs do not create a Firebase community identity until an explicit community action needs one.",
