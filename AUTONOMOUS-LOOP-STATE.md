...
**Current pass:** 2026-06-06 Cycle 54 community quota/rate-limit design
**Last commit before pass:** `8d2af1c` (`feat(community): install app check providers`)
