...
| `com.github.teamnewpipe:NewPipeExtractor:v0.24.8` | `NewPipeExtractor-v0.24.8.jar` | 292 | `a5c92c0ec5bd184258e1e412247528fb0ae0c8ff2ee1e96d87656f2bd8d17c5f` |
| `com.github.teamnewpipe:NewPipeExtractor:v0.24.8` | `NewPipeExtractor-v0.24.8.pom` | 1164 | `ba82f1cf42fad137f5c73b025c1d95993c528742c19d7d47df706360a3d2a48e` |
| `com.github.teamnewpipe.NewPipeExtractor:NewPipeExtractor:v0.24.8` | `NewPipeExtractor-v0.24.8.jar` | 261 | `ae39d0c1c1b6d1424d603c64f5211b175f32d2eb6c188cee5fce76f4a06640d3` |
| `com.github.teamnewpipe.NewPipeExtractor:NewPipeExtractor:v0.24.8` | `NewPipeExtractor-v0.24.8.module` | 2363 | `f72b20cd0b3af1e381bb6b931a2e3b723b5ef13323ce14762f6721a6f1f30911` |
| `com.github.teamnewpipe.NewPipeExtractor:NewPipeExtractor:v0.24.8` | `NewPipeExtractor-v0.24.8.pom` | 1782 | `386d62e59fe80ea47a728df06c844bb03c2b412adc206dc052503be1e89d9b46` |
| `com.github.teamnewpipe.NewPipeExtractor:extractor:v0.24.8` | `extractor-v0.24.8.pom` | 2676 | `2e6cc7f62332dacc8e445a1b0916ab05a7887bd880c8063fe37a5f50957f45a9` |
| `com.github.teamnewpipe.NewPipeExtractor:extractor:v0.24.8` | `extractor-v0.24.8.jar` | 698238 | `847f4a589edddcae2cc8a357e3de496b77103d94a221fc9b41edd5db4467780d` |
| `com.github.teamnewpipe.NewPipeExtractor:extractor:v0.24.8` | `extractor-v0.24.8.module` | 2830 | `fd98c5de69c5adfa1d59ab9b3031f5e4551eb8782d7e277fbff669b2ae8f90b5` |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-generator:v0.24.8` | `timeago-generator-v0.24.8.jar` | 13011 | `32ea643e7c2227e52b79c82b570fbde60db713a68d70e6f7e7145f8f58be5ea0` |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-generator:v0.24.8` | `timeago-generator-v0.24.8.pom` | 1981 | `6c0a2994725f36459a3df2b112b54ff822c62843fb9c7944038bf88d18b6ce8b` |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-generator:v0.24.8` | `timeago-generator-v0.24.8.module` | 2341 | `c9860e3ec918db68679f35a07abc8e573c16eb661d305985f55e0662bf7d8884` |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-parser:v0.24.8` | `timeago-parser-v0.24.8.jar` | 80074 | `39e1177d01e9c8b1c6afe4f7e89678eaae3ebfb0e9dc49bfcb58466c800b629f` |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-parser:v0.24.8` | `timeago-parser-v0.24.8.pom` | 1552 | `155efbe4b0dc323e7d2fb98b8bd42d7097114a357e9e28654db6584a9a132c36` |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-parser:v0.24.8` | `timeago-parser-v0.24.8.module` | 1995 | `225bdc23569d7f208beb2858bb29754a06c5867c29aaf102b98a0f7eb0599f1e` |
...
| `com.github.teamnewpipe:NewPipeExtractor:v0.24.8` | GPL-3.0-or-later | https://github.com/TeamNewPipe/NewPipeExtractor/tree/v0.24.8 | https://raw.githubusercontent.com/TeamNewPipe/NewPipeExtractor/v0.24.8/LICENSE | Marker coordinate; inspect transitive NewPipeExtractor modules for real classes. |
| `com.github.teamnewpipe.NewPipeExtractor:NewPipeExtractor:v0.24.8` | GPL-3.0-or-later | https://github.com/TeamNewPipe/NewPipeExtractor/tree/v0.24.8 | https://raw.githubusercontent.com/TeamNewPipe/NewPipeExtractor/v0.24.8/LICENSE | Aggregator module; no native payload entries matched this inventory. |
| `com.github.teamnewpipe.NewPipeExtractor:extractor:v0.24.8` | GPL-3.0-or-later | https://github.com/TeamNewPipe/NewPipeExtractor/tree/v0.24.8 | https://raw.githubusercontent.com/TeamNewPipe/NewPipeExtractor/v0.24.8/LICENSE | Main extractor module used by Aura's YouTube metadata path. |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-generator:v0.24.8` | GPL-3.0-or-later | https://github.com/TeamNewPipe/NewPipeExtractor/tree/v0.24.8 | https://raw.githubusercontent.com/TeamNewPipe/NewPipeExtractor/v0.24.8/LICENSE | Transitive NewPipeExtractor time parsing helper. |
| `com.github.teamnewpipe.NewPipeExtractor:timeago-parser:v0.24.8` | GPL-3.0-or-later | https://github.com/TeamNewPipe/NewPipeExtractor/tree/v0.24.8 | https://raw.githubusercontent.com/TeamNewPipe/NewPipeExtractor/v0.24.8/LICENSE | Transitive NewPipeExtractor time parsing helper. |
...
### `com.github.teamnewpipe:NewPipeExtractor:v0.24.8` - `NewPipeExtractor-v0.24.8.jar`

No native/payload/license entries matched the inventory filters.

### `com.github.teamnewpipe.NewPipeExtractor:NewPipeExtractor:v0.24.8` - `NewPipeExtractor-v0.24.8.jar`

No native/payload/license entries matched the inventory filters.

### `com.github.teamnewpipe.NewPipeExtractor:extractor:v0.24.8` - `extractor-v0.24.8.jar`

No native/payload/license entries matched the inventory filters.

### `com.github.teamnewpipe.NewPipeExtractor:timeago-generator:v0.24.8` - `timeago-generator-v0.24.8.jar`

No native/payload/license entries matched the inventory filters.

### `com.github.teamnewpipe.NewPipeExtractor:timeago-parser:v0.24.8` - `timeago-parser-v0.24.8.jar`
