...
submission, Android report, vote, and follow callable client adapters, local
...
- Android report, vote, and follow callable adapter test status from focused
  `CommunityCallable`, `CommunityReport`, vote payload, and follow payload unit
