...
| Background work scheduling ledger | `docs/background-work-scheduling-ledger.json`, `docs/background-work-scheduling-ledger.md`, `tools/background_work_scheduling_check.py`, `.github/workflows/verify.yml`, `.github/workflows/release.yml` | Fails PR/main/release checks when WorkManager unique work names, enqueue policies, constraints, deferral reasons, scheduler source terms, release docs, or workflow wiring drift. |
| Background work network posture | `docs/background-work-network-posture.json`, `docs/background-work-network-posture.md`, `tools/background_work_network_check.py`, `.github/workflows/verify.yml`, `.github/workflows/release.yml` | Fails PR/main/release checks when worker connected/unmetered network posture, Data Saver gap text, privacy surfaces, scheduler source terms, release docs, or workflow wiring drift. |
