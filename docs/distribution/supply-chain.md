...
17. Confirm the release workflow ran `tools/store_metadata_preflight.py`, `tools/privacy_policy_link_check.py`, `tools/privacy_data_safety_check.py`, and `tools/play_app_content_packet_check.py` before `:app:assembleRelease`.
