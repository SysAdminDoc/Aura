...
4. Runs the provider credential storage, cleartext release, store metadata preflight, privacy-policy link, Data safety matrix, community guidelines consent, and Play App content checks.
