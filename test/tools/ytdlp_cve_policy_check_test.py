...
def write_policy(repo_root: Path) -> Path:
    ...
    def test_rejects_forbidden_netrc_cmd_option(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with self.assertRaisesRegex(
                ...
                "forbidden yt-dlp netrc command option",
            ):
