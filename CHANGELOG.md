...
## Unreleased
- **Supply-chain CI follow-up (NX-8/NX-12 / Cycle 2 P1)**: OpenSSF Scorecard now runs as SARIF-only with job-scoped code-scanning upload permissions, and Gradle dependency verification metadata includes the clean-runner JUnit BOM module hashes exposed by CI.
